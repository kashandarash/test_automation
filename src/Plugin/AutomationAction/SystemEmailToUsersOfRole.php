 ...
 *
 * @AutomationAction(
 *   id = "social_automation_email_to_users_of_role",
 ...
 */
class SystemEmailToUsersOfRole extends AutomationActionBase implements ContainerFactoryPluginInterface {
  ...
  protected function doExecute(array $roles, $subject, $message, $reply = NULL, LanguageInterface $language = NULL) {
    ...
    foreach ($accounts as $account) {
      ...
      $message = $this->mailManager->mail('social_automation', $key, $account->getEmail(), $langcode, $params, NULL);
