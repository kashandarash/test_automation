...
use Drupal\social_automation\Core\AutomationActionBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Provides "Send email" automation action.
 *
 * @AutomationAction(
 *   id = "social_automation_send_email",
 ...
 */
class SystemSendEmail extends AutomationActionBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('logger.factory')->get('social_automation'),
  ...
  protected function doExecute(array $to, $subject, $message, $reply = NULL, LanguageInterface $language = NULL) {
    ...
    $key = 'automation_action_mail_' . $this->getPluginId();

    $recipients = implode(', ', $to);
    $message = $this->mailManager->mail('automation', $key, $recipients, $langcode, $params, $reply);
    if ($message['result']) {
