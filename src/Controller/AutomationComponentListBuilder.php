...
/**
 * Defines a class to build a listing of AutomationComponentConfig entities.
 *
 * @see \Drupal\social_automation\Entity\AutomationComponent
 */
class AutomationComponentListBuilder extends ConfigEntityListBuilder {
  ...
  /**
   * Constructs a new AutomationComponentListBuilder object.
   *
  ...
  public function buildHeader() {
    $header['label'] = $this->t('Automation Component');
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    $row['plugin']['data-drupal-selector'] = 'automation-table-filter-text-source';
    $row['plugin']['data'] = [
  ...
  public function render() {
    ...
    $build['description'] = [
      '#prefix' => '<p>',
      '#markup' => $this->t('Components are stand-alone sets of Automation configuration that can be used by Automation and other modules on your site. Components are for example useful if you want to use the same conditions, actions or automation in multiple places, or call them from your custom module. You may also export each component separately. See the <a href=":documentation">online documentation</a> for more information about how to use components.', [':documentation' => 'https://www.drupal.org/node/1300024']),
      '#suffix' => '</p>',
    ];
    ...
    $build += parent::render();
    $build['table']['#empty'] = $this->t('No automation components have been defined.');
    $build['table']['#attributes'] = ['class' => ['automation-listing-table']];
