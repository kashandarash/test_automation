 ...
 */
class AutomationComponentRepository implements AutomationComponentRepositoryInterface {

  /**
   * Array of component resolvers, keyed by provider.
   *
   * @var \Drupal\social_automation\Engine\AutomationComponentResolverInterface[]
   */
  protected $resolvers = [];
   ...
   * {@inheritdoc}
   */
  public function get($id, $provider = 'automation_component') {
   ...
   * {@inheritdoc}
   */
  public function getMultiple(array $ids, $provider = 'automation_component') {
