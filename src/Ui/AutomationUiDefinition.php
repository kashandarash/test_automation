...
/**
 * Class for social_automation_ui plugin definitions.
 *
 * Note that the class is treated as value object. Thus, there is no special
 * interface for it.
 *
 * @see \Drupal\social_automation\Ui\AutomationUiManagerInterface
 */
class AutomationUiDefinition implements PluginDefinitionInterface {
  ...
  /**
   * The automation UI handler class.
   *
   ...
   * @var string
   */
  public $class = AutomationUiConfigHandler::class;
   ...
   * the AutomationUiConfigHandler assumes a config entity and uses its label()
   * method.
   *
   * @var string|null
   *
  ...
  public function validate() {
    ...
    if (!is_subclass_of($this->class, AutomationUiHandlerInterface::class)) {
      throw new LogicException("The provided class does not implement the AutomationUiHandlerInterface.");
    }
  }
