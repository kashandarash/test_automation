...
/**
 * Provides automation settings form.
 */
class AutomationSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'social_automation_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['debug_log']['enabled'] = [
      ...
      '#description' => $this->t('Show debug information on screen (in the HTML response). Debug information is only shown when automation are evaluated, and is visible for users having the permission %permission.', [
        '%permission' => Link::createFromRoute('View Automation debug log', 'user.admin_permissions', [], ['fragment' => 'module-automation'])->toString(),
      ]),
