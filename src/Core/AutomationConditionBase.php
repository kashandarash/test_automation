...
use Drupal\social_automation\Context\ContextProviderTrait;

/**
 * Base class for automation conditions.
 *
 * @todo Figure out whether buildConfigurationForm() is useful to Automation somehow.
 */
abstract class AutomationConditionBase extends ConditionPluginBase implements AutomationConditionInterface {
