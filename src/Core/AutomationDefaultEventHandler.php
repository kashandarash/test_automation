 ...
 */
class AutomationDefaultEventHandler extends PluginBase implements AutomationEventHandlerInterface {
  ...
  public function getContextDefinitions() {
    ...
    if ($this instanceof AutomationConfigurableEventHandlerInterface) {
